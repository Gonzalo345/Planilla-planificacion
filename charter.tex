...
\item Probabilidad de ocurrencia (3): los paquetes no siempre se desplazan a la misma velocidad y la iluminación cambia durante el día.
\end{itemize}   
...
Riesgo 1: Con la correcta instalación de la iluminación y con la posibilidad de cambiar la cámara por una de mayor velocidad de obturación se va a lograr conseguir una buena calidad de imagen.  
