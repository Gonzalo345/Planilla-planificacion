...
\begin{enumerate}
\item Creación del proyecto
	\begin{enumerate}
	\item Búsqueda de proyecto (12 hs)
	\item Análisis de de viabilidad (8 hs)
	\item Redacción de la propuesta (8 hs)
	\item Planteo de la propuesta a la empresa (2 hs)
	\item Análisis de materiales necesarios y disponibles (12 hs)
	\item Redacción de la planilla de planificación (8 hs)
	\item Presentación de la propuesta(ITO)
	\end{enumerate}
\item Preparativos
\begin{enumerate}
	\item Búsqueda o compra de materiales necesarios (4 hs)
	...
	\item Conexión de alimentación externa (4 hs)
	\item Puesta a punto del primer prototipo (8 hs)
	\item Captura de las primeras imágenes(ITO)
	...
	\item Conexión de semáforo (4hs)
	\item Diseño de placa de adaptacion de tensiones (12hs)
	\item Corrección entre prototipo y PLC (8 hs)
	\end{enumerate}
\item Capacitación sobre conocimientos necesarios
	\begin{enumerate}
	\item Instalación de sofware como linux, Texmaker y otros (4 hs)
	\item Capacitación en el uso control de versiones con Git (4 hs)
	\item Análisis de librerías a utilizar (8 hs)
	\item Compresión y evaluación de distintas técnicas de procesamiento de imágenes (20 hs)
...
\item Pruebas
	...
	\item Algoritmo de clasificación funcional (ITO)
	\end{enumerate}
\item Implementación
	\begin{enumerate}
	\item Testeo con linea en producción y evaluación de resultados del sistema (20 hs)
	\item Corrección de errores (8 hs)
	\item Generación de informe preliminar(20 hs)
	\item Capacitación de operadores (4 hs)
	\item Creación de manual de usuario (8 hs)
	\end{enumerate}
\item Escritura de la memoria técnica
	\begin{enumerate}
	\item Realización capítulos 1 al 3 la memoria técnica (20 hs) 
	\item Corrección de la memoria técnica (8 hs)
	\item Realización capítulos 4 al 5 la memoria técnica (20 hs)
	\item Corrección de la memoria técnica (8 hs)
	\item Preparación de la defensa publica (8 hs)
	\item Defensa publica (ITO)
