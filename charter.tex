...
\item Desarrollo del proyecto 
	...
	\item Redacción de la propuesta (16 hs)
	\item Planteo de la propuesta a la empresa (6 hs)
	\item Análisis de materiales necesarios y disponibles (12 hs)
	\item Redacción de la planilla de planificación (20 hs)
...
\begin{enumerate}
	...
	\item Diseño de placa de adaptación de tensiones (20hs)
...
\item Capacitación sobre conocimientos necesarios
	...
	\item Compresión y evaluación de técnicas de centrado de imagenes con IA (20 hs) 
	\item Compresión y evaluación de técnicas de procesamiento de imágenes (20 hs)
	\item Análisis de algoritmos y técnicas de clasificacion con IA (20 hs)
	\item Elegir algoritmos(8 hs)
	\end{enumerate}
\item Pruebas y análisis de datos
	\begin{enumerate}
	\item Preparar set de datos (8 hs)
	\item Pre-procesamiento de imágenes tomadas (12 hs)
	\item Multiplicación del set de datos cambiando condiciones de iluminación y tonalidad en las imágenes (12 hs)
	\item Evaluación y pruebas con distintos algoritmos de clasificación de IA (20 hs)
	\item Algoritmo de clasificación funcional (hito)
	\end{enumerate}
\item Implementación
	\begin{enumerate}
	\item Pruebas con linea en producción y evaluación de resultados del sistema (20 hs)
	\item Corrección de errores (8 hs)
	\item Generación de informe preliminar(16 hs)
	\item Capacitación de operadores (4 hs)
	\item Desarrollo del manual de usuario (8 hs)
	\end{enumerate}
\item Escritura de la memoria técnica
	\begin{enumerate}
	\item Realización capítulos 1 al 3 la memoria técnica (30 hs) 
	\item Corrección de la memoria técnica 12 hs)
	\item Realización capítulos 4 al 5 la memoria técnica (30 hs)
	\item Corrección de la memoria técnica (12 hs)
	\item Preparación de la defensa publica (18 hs)
	\item Defensa publica (hito)
...
\begin{figure}[htpb]
\centering 
\includegraphics[width=1\textwidth]{./Figuras/Gantt5.pdf} %angle=90,origin=c,
\caption{Diagrama en \textit{Activity on Node}}
\label{fig:AoN}
\end{figure}
