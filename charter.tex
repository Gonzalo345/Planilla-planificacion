...
\item Desarrollo del proyecto 
	\begin{enumerate}
	\item Búsqueda de proyecto (12 hs)
	\item Análisis de de viabilidad (10 hs)
	\item Análisis de materiales necesarios y dispnibles (12 hs)
	\item Redacción de la planilla de planificación 1-6 (16 hs)
	\item Corrección de la planilla de planificacción (10 hs)
	\item Planteo de la propuesta a la empresa (4 hs)
	\item Cámbio de propuesta redaccion de planilla 1-8 (20 hs)
	\item Redacción de la planilla de planificaición 8-17 (20 hs)
	\item Corrección de la planilla de planificación (10 hs)
	\item Preparar propuesta (6 hs)
	\item Presentación de la propuesta(hito)
	\end{enumerate}
\item Preparativos y desarrollo de prototipo
\begin{enumerate}
	\item Búsqueda o compra de materiales necesarios (10 hs)
	\item Montaje de gabinete y sistema de iluminación (12 hs)
	\item Montaje de componentes internos PC fuentes y conexiones internas (10 hs)
	\item Conexión de alimentación externa (6 hs)
	\item Puesta a punto del primer prototipo (10 hs)
	\item Captura de las primeras imágenes(hito)
	\item Captura de imágenes de muestra de distintos formatos de cepita(20 hs) 
	\item Captura de imágenes de muestra de distintos formatos de powerade(20 hs)
	\item Conexión de semáforo (6hs)
	\item Diseño de placa de adaptación de tensiones (20 hs)
	\item Corrección entre prototipo y PLC (10 hs)
	\end{enumerate}
\item Capacitación sobre conocimientos necesarios
	\begin{enumerate}
	\item Instalación de sofware como linux, Texmaker y otros (6 hs)
	\item Capacitación en el uso control de versiones con Git (6 hs)
	\item Análisis de librerías a utilizar (20 hs)
	\item Evaluacion de tecnicas de centrado de imagenes con IA (20 hs) 
	\item Evaluación de técnicas de procesamiento de imágenes (20 hs)
	\item Análisis de algoridmos y técnicas de clasificación con IA (20 hs)

	\item Análisis de algoritmos y técnicas de clasificacion con IA (20 hs)
	\item Elegir algoritmos(12 hs)
	\end{enumerate}
\item Pruebas y análisis de datos
	\begin{enumerate}
	\item Preparar set de datos (30 hs)
	\item Pre-procesamiento de imágenes tomadas (15 hs)
	\item Multiplicación del set de datos cambiando condiciones de iluminación y tonalidad en las imágenes (20 hs)
	\item Algoritmo de clasificación funcional (20 hs)
	\end{enumerate}
\item Implementación
	\begin{enumerate}
	\item Pruebas con linea en producción y evaluación de resultados del sistema (25 hs)
	\item Corrección de errores (20 hs)
	\item Generación de informe preliminar(16 hs)
	\item Capacitación de operadores (16 hs)
	\item Desarrollo del manual de usuario (20 hs)
	\end{enumerate}
\item Escritura de la memoria técnica
	\begin{enumerate}
	\item Realización capítulos 1 al 3 la memoria técnica (40 hs) 
	\item Corrección de la memoria técnica 18 hs)
	\item Realización capítulos 4 al 5 la memoria técnica (40 hs)
	\item Corrección de la memoria técnica (18 hs)
	\item Preparación de la defensa publica (10 hs)
	\item Defensa publica (4 hs)
...
En la figura \ref{fig:AoN} podemos observar el Diagrama de \textit{Activity on Node} en el cual la unidad de tiempo t esta expresada en semanas y las flechas mas gruesas indican el camino critico.
\newline
...
\begin{figure}[h]
\centering 
\includegraphics[angle=270,width=1\textwidth]{./Figuras/Gantt5.pdf} %angle=90,origin=c,
