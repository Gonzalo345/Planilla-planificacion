...
%Por ejemplo:
\begin{itemize}
\item Cliente: se encuentra de vacaciones regresa el 05/04/2021.
...
%\item Gabinete metálico y protección de acrı́ico para el equipo.
	\item Gabinete metálico preferentemente de acero inoxidable con un grado de protección IP66 de al menos 30cm x 30cm x 24cm.
	\end{enumerate}
...
\begin{enumerate}
\item Grupo de tareas 1 Creacion del proyecto
	\begin{enumerate}
	...
	\item Captura de imagenes de muestra (20 hs) 
	...
	\item Creacion de esquematico con conexiones electricas (12hs)
	\end{enumerate}
\item Grupo de tareas 2 Capacitacion sobre conocimientos necesarios
	\begin{enumerate}
	...
	\item Evaluacion de resultados del sistema (20 hs)
	\item Generacion de informe (20hs)
	\item Capacitacion de operadores (4hs)
