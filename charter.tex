...
%Por ejemplo:
\begin{itemize}
\item Cliente: se encuentra de vacaciones.
...
\begin{consigna}{black}
El propósito de este proyecto es crear un control de calidad de el proceso de impresion en la fecha de vencimiento de los paquetes de botellas de cepita o powerade, creando las bases para poder optimizar otros controles en un futuro.
Este control actualmente lo realiza un operador el cual tambien realiza otras actividades no percatandose a veces de las fallas de impresion.
\end{consigna}
...
Se mostrara el resultado en un semáforo y transmitira la señal por lógica de 24v. El proyecto no incluye la programación de la detención de la línea.
...
\item Habra disposición de materiales y/o repuestos que no se estén utilizando en las líneas de producción como cámaras o luces LED.
